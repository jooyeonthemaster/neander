...
import { NEWS_CATEGORY_LABELS, type NewsArticle, type NewsCategory } from '@/types/admin'
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await updateDoc(doc(db, 'news', articleId), {
        ...
        published_at: form.is_published ? (originalPublishedAt || now) : null,
  ...
  if (notFound) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <Link
          href="/admin/news"
          className="inline-flex items-center gap-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 px-4 py-2.5 rounded-lg hover:bg-gray-50 transition-colors"
        >
